...
ax1.pcolormesh(dem_lons, dem_lats, dem, cmap='terrain', vmin=0, vmax=4000, alpha=1, transform=ccrs.PlateCarree())
...
ax1.text(corner_x1[0]+length_x[0]*0.05, corner_y1[0]+length_y[0]*0.9, 'D01 = 18 Km',
...
ax1.text(corner_x2[0]+length_x[1]*0.05, corner_y2[0]+length_y[1]*1.1, 'D02 = 6 Km',
...
ax1.text(corner_x3[0]+length_x[2]*0.1, corner_y3[0]+length_y[2]*0.8, 'D03 = 3 Km',
...
##ax1.xlocator = mticker.FixedLocator(xticks)
ax1.set_title('WRF nested domain setup (2019 SWIO event)', size=18)
...
#cb1.set_ticklabels(['0','1000','2000', '3000', '4000', '5000'])
